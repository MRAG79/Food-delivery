  ...
  return (
    <div className='w-full h-[120px] p-2 shadow-lg flex justify-between'>
        <div className='w-[60%] h-full flex gap-5'>
            ...
            <div className='w-[40%] h-full flex flex-col gap-5'>
                ...
                <div className='w-[110px] h-[50px] bg-slate-400 flex rounded-lg shadow-lg overflow-hidden font-semibold border-2 border-green-400 text-xl'>
                    <button className='w-[30%] h-full bg-white flex justify-center items-center text-green-400 hover:bg-gray-100'>-</button>
        ...
        <div className='flex flex-col justify-start items-end gap-6'>
            ...
            <RiDeleteBin6Line className='w-[20px] h-[20px] text-red-400' />
        </div>
    </div>
  )
}
